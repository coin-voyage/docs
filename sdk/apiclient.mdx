...
description: "Initialize ApiClient from @coin-voyage/paykit/server and navigate its order, wallet, on-ramp, off-ramp, invoice, fee, webhook, and type references."
layout:
  description:
    visible: false
---
...
<CardGroup cols={2}>
  ...
  <Card title="Swaps" icon="arrows-rotate" href="/sdk/apiclient/swaps">
    Request standalone swap quotes and execution instructions.
  </Card>
