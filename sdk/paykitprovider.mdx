...
<ParamField path="customTheme" type="object">
  Override specific modal styles to match your branding. Accepts a `CustomTheme` object keyed by supported CSS custom properties. See [Styling / Theme](/sdk/styling/paykit) for an example and common properties.
</ParamField>
