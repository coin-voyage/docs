...
description: "Configure PayKitProvider with your API key, theme, environment, wallet callbacks, and global PayKitOptions to control every aspect of the payment modal."
layout:
  description:
    visible: false
---
...
<ParamField path="options.language" type="Languages">
...
<ParamField path="options.walletConnectCTA" type="string" default="both">
...
<ParamField path="options.embedGoogleFonts" type="boolean">
