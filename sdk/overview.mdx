...
Approved organizations can offer a fiat-funded on-ramp option inside the same PayKit modal. The option appears alongside the crypto-first paths users already see, such as **Pay to Address** and **Pay with Wallet**.
