...
sidebarTitle: "PayKit quickstart"
    ...
    export function DepositButton() {
      return (
        <PayButton
          ...
          onAwaitingPayment={() => console.log("Awaiting payment")}
          onConfirmingPayment={() => console.log("Payment confirming")}
          onExecutingPayment={() => console.log("Payment executing")}
...
<CardGroup cols={2}>
  <Card title="PayKit reference" icon="book" href="/sdk/overview">
    Explore provider options, PayButton props, and payment status hooks.
  </Card>
