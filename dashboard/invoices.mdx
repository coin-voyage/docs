...
<Info>
  To automate invoice creation, drafts, listing, and lifecycle management, see the complete [Invoices guide](/invoices/overview) and [Invoices API](/invoices/api).
</Info>
...
Once your customer completes the payment, CoinVoyage settles the funds to you in your preferred currency and chain, as configured in your [Settlement settings](/dashboard/settlement). You do not need to handle conversion or routing manually.
