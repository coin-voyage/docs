...
<Info>
  Current docs describe the v3 API and PayKit `3.0.0` surface. If you are upgrading from v2, start with the [v2 to v3 migration guide](/resources/migration-v2-to-v3). Older entries below are retained for historical context.
</Info>
