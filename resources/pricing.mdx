...
description: "CoinVoyage charges 6% per successful transaction with 0.5% off-ramp fees. Volume discounts are available on request."
layout:
  description:
    visible: false
---

CoinVoyage is free to get started. Pricing is usage-based with transparent transaction fees and no hidden platform costs. You can contact [help@coinvoyage.io](mailto:help@coinvoyage.io) to discuss reduced rates once your volume grows.

## Fee schedule

| Fee type | Standard rate | Description |
| --- | --- | --- |
| Transaction fee | 6% | Applied to each successful payment transaction. |
| Swap fee | 0.25% | Applied to each successful swap. |
| Off-ramp fee | 0.5% | Applied when withdrawing to fiat. |
...
<CardGroup cols={3}>
  ...
  <Card title="Choose supported chains" icon="link">
    Accept payments across Bitcoin, Ethereum, Solana, Sui, and supported EVM networks including Arbitrum, Base, Optimism, Polygon, BSC, and Robinhood Chain.
  </Card>
...
- **Bitcoin** (BTC)
- **Ethereum** and EVM-compatible chains — Arbitrum, Base, Optimism, Polygon, BSC, Robinhood Chain
- **Solana** (SOL)
- **Sui** (SUI)
...
<Note>
  To discuss volume pricing, email [help@coinvoyage.io](mailto:help@coinvoyage.io) or visit the [Support](/resources/support) page.
</Note>
