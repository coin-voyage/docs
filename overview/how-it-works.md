...
#### 4. Quote Selection and Payment Details
...
- **Amount verification** - Ensures the correct amount was received
...
4. Transaction hashes are recorded on-chain

If any step fails:

1. Automatic refund is initiated
2. Funds return to the user's refund address
...
- **Transparent** - All fees and routes are shown upfront
