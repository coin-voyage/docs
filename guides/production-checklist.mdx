---
title: "Production checklist: launch CoinVoyage payments safely"
...
- [ ] If not using a settlement currency, make sure pay-order generation specifies a `receiving_address` and `asset` at all time.
